...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Play Human vs AlphaZero and update AlphaZero from AlphaZero turns only.",
    ...
    renderer = TkinterRenderer(title="Train AlphaZero vs Human")
